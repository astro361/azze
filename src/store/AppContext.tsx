...
import { mockUser, mockProjects, mockDeployments, mockGitHubRepos, mockEnvVars, buildLogTemplates } from './mockData';
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const login = useCallback(async (_provider: 'google' | 'github') => {
    ...
    setUser(mockUser);
    setIsAuthenticated(true);
    localStorage.setItem('azze_user', JSON.stringify(mockUser));
    loadUserData();
    setIsLoading(false);
  }, []);
