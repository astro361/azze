...
### 🔐 Authentication
- **Landing Gate:** Strict portal for unauthenticated users (Google & GitHub OAuth).
- **Onboarding Flow:** Interstitial profile setup screen explicitly requiring full name, display name, phone number, and a built-in avatar selector. No infinite loops.
- **Supabase Integration:** Built entirely on top of Supabase Auth metadata.

### 📊 Dashboard
- Clean User Profile and deployment activity overview.
- Sidebar navigation leading to Video Feed, Community Chat, and Services.
